...
from core.extensions.face_sdk.core.model_loader.BaseModelLoader import BaseModelLoader
...
class FaceDetModelLoader(BaseModelLoader):
    ...
    def load_model(self):
        try:
            model = torch.load(config_path+'/'+self.cfg['model_file_path'], map_location=torch.device('cpu'))
