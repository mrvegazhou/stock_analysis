...
from core.extensions.redprint import Redprint as _Redprint
from core.extensions.api_docs.swagger_filed import SwaggerSpecs

class RedprintWithDoc(_Redprint):
    def __init__(self, name, module, description='', api_doc=None, alias=''):
        ...
        super(RedprintWithDoc, self).__init__(name, module)
